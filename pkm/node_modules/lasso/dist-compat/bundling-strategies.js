        ...
        return {
            getBundleForSyncDependency: function (dependency, walkContext, debugTree) {
                ...
                if (bundleMapping) {
                    ...
                    bundle = bundleMappings.addDependencyToPageBundle(dependency, pageBundleName, walkContext.slot, null, lassoContext);
                }
            ...
            getBundleForAsyncDependency: function (dependency, walkContext, debugTree) {
                ...
                if (bundle) {
                    ...
                    bundle = bundleMappings.addDependencyToPageBundle(dependency, asyncPageBundleName, walkContext.slot, null, lassoContext);
                }
    ...
    'lean': function (options, config, bundleMappings, pageBundles) {
        ...
        return {
            getBundleForSyncDependency: function (dependency, walkContext, debugTree) {
                ...
                if (bundleMapping && !bundleMapping.bundle.isAsyncOnly()) {
                    bundle = pageBundleMappings.addDependencyToPageBundle(dependency, bundleMapping.bundle.getName(), walkContext.slot, bundleMapping.bundle.getConfig(), lassoContext);
                } else {
                    bundle = pageBundleMappings.addDependencyToPageBundle(dependency, pageBundleName, walkContext.slot, null, lassoContext);
                }
            ...
            getBundleForAsyncDependency: function (dependency, walkContext, debugTree) {
                ...
                if (bundle) {
                    ...
                    if (bundleMapping) {
                        ...
                        bundle = pageBundleMappings.addDependencyToPageBundle(dependency, bundleName, walkContext.slot, bundleMapping.bundle.getConfig(), lassoContext);
                    } else {
                        bundle = pageBundleMappings.addDependencyToPageBundle(dependency, asyncPageBundleName, walkContext.slot, null, lassoContext);
                    }
