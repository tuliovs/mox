let lassoPage = (() => {
    var _ref = _asyncToGenerator(function* (pageConfig) {
    ...
    return function lassoPage(_x) {
        return _ref.apply(this, arguments);
    };
})();

let lassoResource = (() => {
    var _ref2 = _asyncToGenerator(function* (path, context) {
        return getDefaultLasso().lassoResource(path, context);
    });

    return function lassoResource(_x2, _x3) {
