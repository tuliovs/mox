    ...
    function transformAsyncCall(asyncBlock) {
        ...
        if (asyncBlock.packageIdProvided) {
            ...
            if (name) {
                ...
                stringTransformer.insert(firstArgRange[0], '[' + JSON.stringify(name) + ',' + packageIdExpression + ']');
            }
...
exports.create = function (config, lasso) {
    return {
        ...
        read: function (lassoContext) {
            ...
            return streamToString(stream).then(code => {
                if (isObject) {
                    ...
                    var defCode = transport.codeGenerators.define(path, transformedCode, {
        ...
        getLastModified(lassoContext) {
            ...
            return _asyncToGenerator(function* () {
                return _this.requireLastModified;
            })();
        },
