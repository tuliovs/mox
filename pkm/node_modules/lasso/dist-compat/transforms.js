let filterTransform = (() => {
    var _ref = _asyncToGenerator(function* (lassoContext, transformConfig) {
        return transformConfig.filter ? transformConfig.filter(lassoContext) : true;
    });

    return function filterTransform(_x, _x2) {
    ...
    var outStream = through(function write(data) {
        ...
        if (transformedCode != null) {
            if (typeof transformedCode === 'string') {
                ...
                transformedCode.then(function (transformedCode) {
                    handleTransformedCode(transformedCode);
                }).catch(handleError);
            } else {
...
exports.createTransformer = (() => {
    var _ref2 = _asyncToGenerator(function* (unfilteredTransforms, lassoContext) {
        ...
        for (const unfilteredTransform of unfilteredTransforms) {
            const keep = yield filterTransform(lassoContext, unfilteredTransform);
            if (keep) {
