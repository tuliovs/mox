...
BundleMappings.prototype = {
    ...
    addDependencyToPageBundle: function (dependency, pageBundleName, dependencySlot, bundleConfig, lassoContext) {
        ...
        if (this.inPlaceDeploymentEnabled && dependency.isInPlaceDeploymentAllowed()) {
            ...
            bundle = this.addDependencyToBundle(dependency, dependency.getSourceFile(), dependencySlot, bundleConfig, lassoContext);

            bundle.dependency = dependency;
            bundle.inPlaceDeployment = true;
        } else if (dependency.isExternalResource()) {
            bundle = this.addDependencyToBundle(dependency, dependency.getUrl(), dependencySlot, bundleConfig, lassoContext);
            ...
            bundle = this.addDependencyToBundle(dependency, finalBundleName, dependencySlot, null, lassoContext);
            ...
            bundle = this.addDependencyToBundle(dependency, defaultBundleName || pageBundleName, dependencySlot, bundleConfig, lassoContext);
        }
